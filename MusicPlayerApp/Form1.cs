...
namespace MusicPlayerApp
{
    public partial class MusicPlayerApp : Form
    {
        ...
        private void MusicPlayerApp_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (WindowsMediaPlayerMusic.playState == WMPLib.WMPPlayState.wmppsPlaying)
                {
                    WindowsMediaPlayerMusic.Ctlcontrols.pause();
                }
                else
                {
                    WindowsMediaPlayerMusic.Ctlcontrols.play();
                }
